...
we created a small simulation study of 256 units with half
assigned to a binary treatment completely at random. We compared two outcomes
--- a Normal outcome and a skewed outcome, both with mean of 10 and standard
deviation of 1. And we compared two models of effects --- a constant additive
